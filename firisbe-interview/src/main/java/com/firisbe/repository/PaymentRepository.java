...
public interface PaymentRepository extends JpaRepository<Payment, Integer> {
	...
	public Page<Payment> findByCardNumberOrCustomerNumber(@Param("customerNumber") String customerNumber,
...
//			@Param("cardNumber") String cardNumber);
	...
	public Page<Payment> getAllPaymentsBetweenDates(@Param("startDate") LocalDateTime startDate,
